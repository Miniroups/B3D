...
<body>
  ...
  <section id="mentions">
    ...
    <p>Conformément à la réglementation, vous disposez d'un droit d'accès, de modification, de rectification et de suppression des données qui vous concernent. Pour se faire, l'utilisateur devra s'adresser à :
    <ul>
      <li>Société B3D</li>
      <li>"l'Intendant"</li>

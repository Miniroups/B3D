...
public static $FR = [ // français
  ...
  'form_submit' => 'Envoyer',
  'form_error_message_1' => 'WARNING: unexpected input !',
  'form_error_message_2' => 'Information requise',
  'form_error_message_3' => 'Information trop longue',
  'form_error_message_4' => 'Caractères rejetés: &amp; &quot; &lt; &gt;',
  'form_error_message_5' => 'Choix invalide',
  'form_error_message_6' => 'Format invalide',
  'form_error_message_7' => 'Adresse invalide',
  'form_error_message_8' => 'Format invalide',
  'form_status_message_1' => 'Votre message a bien été envoyé.',
  'form_status_message_2' => 'Une erreur s\'est produite. Veuillez réessayer ultérieurement.',
  // Index
...
public static $EN = [ // english
  ...
  'form_submit' => 'Submit',
  'form_error_message_1' => 'WARNING: unexpected input !',
  'form_error_message_2' => 'Required information',
  'form_error_message_3' => 'Information too long',
  'form_error_message_4' => 'Rejected characters: &amp; &quot; &lt; &gt;',
  'form_error_message_5' => 'Invalid choice',
  'form_error_message_6' => 'Invalid format',
  'form_error_message_7' => 'Invalid address',
  'form_error_message_8' => 'Invalid format',
  'form_status_message_1' => 'Your message has been sent.',
  'form_status_message_2' => 'An error has occurred. Please retry later.',
  // Index
...
public static $ES = [ // español
  ...
  'form_error_message_1' => 'WARNING: unexpected input !',
  'form_error_message_2' => 'Informacion requerida',
  'form_error_message_3' => 'Información demasiado larga',
  'form_error_message_4' => 'Letras rechazados: &amp; &quot; &lt; &gt;',
  'form_error_message_5' => 'Elección inválida',
  'form_error_message_6' => 'Formato inválido',
  'form_error_message_7' => 'Dirección inválida',
  'form_error_message_8' => 'Formato inválido',
  'form_status_message_1' => 'Tu mensaje ha sido enviado.',
  'form_status_message_2' => 'Se ha producido un error. Por favor, vuelva a intentarlo más tarde.',
  // Index
...
// Header
  ...
  'form_submit' => 'Senden',
  'form_error_message_1' => 'WARNING: unexpected input !',
  'form_error_message_2' => 'Erforderliche Informationen',
  'form_error_message_3' => 'Informationen zu lang',
  'form_error_message_4' => 'Abgelehnte Zeichen: &amp; &quot; &lt; &gt;',
  'form_error_message_5' => 'Ungültige Wahl',
  'form_error_message_6' => 'Ungültiges Format',
  'form_error_message_7' => 'Ungültige Adresse',
  'form_error_message_8' => 'Ungültiges Format',
  'form_status_message_1' => 'Ihre Nachricht wurde gesendet.',
  'form_status_message_2' => 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es später erneut.',
  // Index
...
public static function get($language) {
  ...
  switch($language) {
    ...
    default: return self::$FR;
  }
}

} // Translations

$LG = []; // GLOBAL LANGUAGE VARIABLE

$defaultLanguage = 'fr';
  
if(isset($_GET['lg'])) {

  if(!in_array($_GET['lg'], ['fr', 'en', 'es', 'de'])) {
    
    $_SESSION['language'] = $defaultLanguage;
    
    $LG = Translations::get($defaultLanguage);
  }
  else {
    
    $_SESSION['language'] = $_GET['lg'];
    
    $LG = Translations::get($_GET['lg']);
  }
}
...
else { $LG = Translations::get($_SESSION['language']); }
